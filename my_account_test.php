                                                                ...
                                                                if($imgSize2 > 0) {
                                                                                ...
                                                                                if (move_uploaded_file($tmp_file2, $img_path2) == false) {
                                                                                    ...
                                                                                    if($rewardsID[$i] != null){
                                                                                        ...
                                                                                        $rSuccess = qr("UPDATE tblRewards SET fldTitle = \"$rewardsTitle[$i]\", fldDescription = \"$rewardsDesc[$i]\", fldSupport = \"$rewardsSupport[$i]\", 
                                                                                                ...
                                                                                                fkProjectID = \"$projectID\" WHERE pkRewardID = \"$rewardsID[$i]\"");
                                                                                    }else{
                                                                                        //full insert
                                                                    ...
                                                                    if($rewardsID[$i] != null){
                                                                        ...
                                                                        $rSuccess = qr("INSERT INTO tblRewards (fldTitle, fldDescription, fldSupport, fldNumAvailable, fldRewardMonth, fldRewardYear, fkProjectID, fldRewardsLeft) VALUES(
                                                                                                               \"$rewardsTitle[$i]\", \"$rewardsDesc[$i]\", \"$rewardsSupport[$i]\", \"$rewardsAvail[$i]\", \"$rewardsMonth[$i]\", \"$rewardsYear[$i]\", \"$projectID\", \"$rewardsAvail[$i]\")");
                                                                    }
                                                                    if($rSuccess){
                                                                        $report_msg[] = "Reward: " . $rewardsTitle[$i]. " was successfully added";
                                                                    }
...
?>
                    	<p>
                    		<?
                    			if ($fldStatus == 'review'){
                    				echo "<a href=\"edit-project_test.php?id=$projectID\">edit your project</a> <i style='font-size: 11px;'>(You can edit your project until its APPROVED)</i><br />\n";
                    			}
                    		?>
                    		<a href="/project_test.php?id=<?=$projectID?>">view your project</a><br />
                    		<?
                    			if ($fldStatus == 'unapproved'){
                    				echo "<a href=\"submit-project.php\">submit a new project</a><br />\n";
                    			}
                    		?>
                                <a href="/reward-sales.php?id=<?=$projectID?>">view sold rewards</a><br/>
