...
and Feed every Hungry American child! &nbsp;&nbsp;<a href="about.html"><img src="images/findout_btn.png" alt="Find Out More!" class="more-btn" /></a>
		</div>
	</div>
	<div id="imageBox">
	...
	<div id="email-container">
		...
		email sign up form will go here
	</div>
