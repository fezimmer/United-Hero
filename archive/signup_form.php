<a href="unitedmail/"><img src="images/goto-login-btn.png" alt="login to email account" /></a>
        ...
        <div style="width:120px; float:left;">
            ...
            <h3></h3>
           <!-- Age <input type="text" name="age" id="age" class="signup-input" style="width:25px;" />--> Your City: <input type="text" name="location" id="location" class="signup-input" style="width:126px;" />
            <h3></h3>
