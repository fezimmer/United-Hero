				...
				<p>
				  ...
				  <?=$daysRemaining?> DAYS REMAIN
					...
					<div class="project-cta">
						<a href="/rewards.php?id=<?if($pkProjectID == null) echo $projectID; else echo $pkProjectID; ?>&support=yes" class="support" style="margin-left: 10px; font-size: 19px; width:185px;">Support this Product</a>
					</div>
					<!--div class="desc">
